...
from umlars_translator.core.utils.delayed_caller import DelayedCaller, evaluate_elements_afterwards


@inject
class UmlModelBuilder(DelayedCaller):
    def __init__(self, model: Optional[UmlModel] = None, logger: Optional[Logger] = None) -> None:
        self._model = None
